...
if [ -d "$PREFIX" ];then
wget $DOWNLOAD_URL/config_file/php73.ini -O $PREFIX/php-templete.ini
fi
PREFIX="/vhs/kangle/ext/php74"
if [ -d "$PREFIX" ];then
wget $DOWNLOAD_URL/config_file/php74.ini -O $PREFIX/php-templete.ini
fi
PREFIX="/vhs/kangle/ext/php80"
if [ -d "$PREFIX" ];then
wget $DOWNLOAD_URL/config_file/php80.ini -O $PREFIX/php-templete.ini
fi
